 ...
 * @author HP
 */
@WebServlet(name = "ProjectEmpRoleListEdit", urlPatterns = {"/ProjectEmpRoleListEdit"})
public class ProjectEmpRoleListEdit extends HttpServlet {
    
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {

        System.out.println("________Project  Emp  Role  List  Edit_______________");
        ...
        try {
            ...
            List<ProjectEmployees> list = sess.createQuery("From ProjectEmployees Where projects_id='" + id + "'").list();
