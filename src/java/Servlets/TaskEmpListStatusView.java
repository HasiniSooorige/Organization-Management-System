 ...
 * @author HP
 */
@WebServlet(name = "TaskEmpListStatusView", urlPatterns = {"/TaskEmpListStatusView"})
public class TaskEmpListStatusView extends HttpServlet {

    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        System.out.println("_____Task  Emp  List  Status  View_____");
        ...
        try {
            ...
            List<TaskAssignEmployees> list = sess.createQuery("From TaskAssignEmployees Where project_tasks_id='" + id + "'").list();
