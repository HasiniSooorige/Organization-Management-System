...
//function saveDocumments() {
//                
//               alert("save_document_sata");
//
//
//
////                var nic_doc = document.getElementById("nic_doc").files[0];
////                var birth_cert = document.getElementById("birth_cert").files[0];
...
////                
////                names.push(uploadFile.files[i].name);
////                    alert(names.push(uploadFile.files[i].name));
////                }
//                
//                
//                
...
////        alert(names.push(elem.files[i].name));
////}
//                
//                
//                
...
////                form.append("nic_doc", nic_doc);
////                form.append("birth_cert", birth_cert);
//                form.append("uploadFile", names);
//
//
//                alert(form);
//
...
//                    }
//                };
//                request.open("POST", "CreateDocument", true);
//                request.send(form);
//            }


// alert("nic_local_storage");
// alert(nic);
...
function editPayrollData() {
    document.getElementById("emailErrNotify").setAttribute("hidden", "");
}


function loademployees_all() {
//    alert("loadusers_all_servlet_fun");
//    var request = new XMLHttpRequest();
//
//    request.onreadystatechange = function() {
...
////            alert("OK");
//
//            document.getElementById("loadusers").innerHTML = response;
//        }
//    };
//
//    request.open("GET", "loadusers_all_servlet", true);
//    request.send();
...
function editRowData(value) {
    ...
    localStorage.setItem('epfno', value);
    window.location = '../main-pages/employee-edit.jsp?epfno=' + value;
}
...
//          var div =document.getElementById("nicErr").innerHTML =
//                "<b>NIC is required</b>";

//        var div = document.getElementById('nicErrNotify').innerHTML;
//        div.style.visibility = 'visible';

//        document.getElementById("nicErrNotify").style.visibility="visible";
//document.getElementById("nicErrNotify").style.visibility="visible";

        document.getElementById("nicErrNotify").removeAttribute("hidden");
        return false;
    } else {
//        document.getElementById('nicErr').innerHTML = '';
//document.getElementById("nicErrNotify").style.visibility="hidden";
//document.getElementById("nicErrNotify").removeAttribute("hidden");
        document.getElementById("nicErrNotify").setAttribute("hidden", "");
    }
...
//            window.location="auth-login-basic.jsp";
                    sendMail(nic, password, email, first_name);
                    field_clear();
                }
//                            
//                            else 
...
//                            alert(response);
    ...
    request.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
    request.send("nic=" + nic + "&first_name=" + first_name + "&last_name=" + last_name + "&address1=" + address1 + "&address2=" + address2 + "&address3=" + address3 + "&mobile_no=" + mobile_no + "&home_no=" + home_no + "&country_id=" + country_id + "&email=" + email + "&password=" + password + "&epf_no=" + epf_no + "&organization_by=" + organization_by + "&designation=" + designation + "&username=" + nic + "&gender=" + gender);
...
function login(uuser, upassword) {
    ...
    request.onreadystatechange = function () {
        ...
        if (request.readyState === 4 && request.status === 200) {
            ...
            } else if (output[0].message === "Invalid Username or Password.") {
                document.getElementById("upasswordErr").innerHTML =
                        "<b>Invalid Username or Password.</b>";

            } else if (output[0].message === "Your Account is Suspended. Please contact System Admin.") {
                document.getElementById("upasswordErr").innerHTML =
                        "<b>Your Account is Suspended. Please contact System Admin.</b>";
    ...
    request.onreadystatechange = function () {
        ...
        if (request.readyState === 4) {
            if (request.status === 200) {
                ...
                document.getElementById("clientAddress1").setAttribute("value", obj.address1);
                document.getElementById("clientAddress2").setAttribute("value", obj.address2);
                document.getElementById("clientAddress3").setAttribute("value", obj.address3);
    ...
    request.onreadystatechange = function () {
        ...
        if (request.readyState === 4) {
            if (request.status === 200) {
                ...
                document.getElementById("editstatus1").setAttribute("value", obj.statusName);
                document.getElementById("clientEdit1").setAttribute("value", obj.generalOrganizationProfileName);
                document.getElementById("clientAddressEdit1").setAttribute("value", obj.address1);
                document.getElementById("clientAddressEdit2").setAttribute("value", obj.address2);
                document.getElementById("clientAddressEdit3").setAttribute("value", obj.address3);
                document.getElementById("countryNameEdit1").setAttribute("value", obj.countryName);
                show_modal();
            }
        }
    };
...
//                    tdEmployeeId.textContent = employee.EmpId;
            ...
            if (req.status === 200) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    if (employee.Attendance === "2") {
                        tdProjectRole.textContent = "Available at office";
                    } else {
                        tdProjectRole.textContent = "Unavailable at office";
                    }
