<%-- 
    Document   : user-help-ticket-dashboard
    Created on : Jan 10, 2024, 6:50:56 PM
    Author     : HP
--%>
...
<html lang="en"
    ...
    <head>
        ...
        <title>Exon User | Ticket Dashboard</title>
                                ...
                                <div class="card mb-4">
                                    <div class="col-12 offset-12 mt-3 mb-3">
                                        ...
                                        <div style="float: right">
                                            <label>Status: &nbsp;&nbsp;&nbsp;&nbsp;</label>
                                            <span>
                                                <input class="form-check-input" type="checkbox" value="" id="allUser" onclick="filterHelpTicketUser();" checked>
                                                <label class="form-check-label" for="allUser">
                                                    All &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                </label>
                                            </span>
                                            <span>
                                                <input class="form-check-input" type="checkbox" value="" id="pendingUser" onclick="filterHelpTicketUser();">
                                                <label class="form-check-label" for="pendingUser">
                                                    Pending &nbsp;&nbsp;&nbsp;&nbsp;
                                                </label>
                                            </span>
                                            <span>
                                                <input class="form-check-input" type="checkbox" value="" id="ongoingUser" onclick="filterHelpTicketUser();">
                                                <label class="form-check-label" for="ongoingUser">
                                                    Ongoing &nbsp;&nbsp;&nbsp;&nbsp;
                                                </label>
                                            </span>
                                            <span>
                                                <input class="form-check-input" type="checkbox" value="" id="solvedUser" onclick="filterHelpTicketUser();">
                                                <label class="form-check-label" for="solvedUser">
                                                    Solved &nbsp;&nbsp;&nbsp;&nbsp;
                                                </label>
                                            </span>
                                            <span>
                                                <input class="form-check-input" type="checkbox" value="" id="closedUser" onclick="filterHelpTicketUser();">
                                                <label class="form-check-label" for="closedUser">
                                                    Closed &nbsp;&nbsp;
                                                </label>
                                            </span>
                                        </div>
                                    ...
                                    <div class="table-responsive text-nowrap" id="tableHelpTicketDataDiv">
                                        <table class="table" id="ticketTable">
                                            ...
                                            <tbody class="table-border-bottom-0" id="helpTicketTableBody">
                                                <%                                                    int userGUPId;
                                                    if (LOGINUSER) {
                                                        Object userGupValue = request.getSession().getAttribute("C_GUP");
                                                        userGUPId = (Integer) userGupValue;
                                                    } else {
                                                        Object userGupValue = request.getSession().getAttribute("Emp_GUP");
                                                        userGUPId = (Integer) userGupValue;
                                                    }

                                                    List<HelpTicket> list = sess.createQuery("From HelpTicket Where requested_by='" + userGUPId + "'").list();

                                                    if (!list.isEmpty()) {

                                                        for (HelpTicket ticket : list) {
                                                ...
                                                <tr class="<%=row_color%>">
                                                    ...
                                                    <td>
                                                        <a class="btn rounded-pill btn-outline-success" href="user-ticket-view.jsp?tid=<%=ticket.getId()%>" target="_blank" id="<%=ticket.getTicketId()%>">View</a>
                                                    </td>
                                                </tr>
                                                <%
                                                        }
