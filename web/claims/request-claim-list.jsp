<%-- 
    Document   : request-claim-list
    Created on : Sep 12, 2023, 12:42:59 PM
...
<%--<%@page import="Model.Mapping.RequestClaim"%>--%>
...
<html
    ...
    <head>
        ...
        <title>Exon Admin | Request Claim List</title>
    ...
    <body>
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-1 mb-1"><span class="text-primary fw-light">
                                    Admin - Department Head Approval(1st Approval)</span>
                            </h4>
                            <h6 class="fw-bold py-1 mb-4"><span class="text-muted fw-light">
                                    Tasks . Admin - Approve Request Claims </span>
                            </h6>
                            <div class="row">
                                                        ...
                                                        <div style="float: left;">
                                                            <div class="navbar-nav align-items-start">
                                                                <div class="nav-item d-flex align-items-center">
                                                                    ...
                                                                    <input type="text" class="form-control border-0 shadow-none ps-1 ps-sm-2" placeholder="Search..." aria-label="Search..." oninput="searchHClaims();">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12 m-2">

                                                            <div class="table-responsive text-nowrap" id="hClaimDataDiv">
                                                                <table class="table table-hover" id="hclaimTable" >
                                                                    <thead class="sticky-header table-light" id="hclaimsHead">
                                                                        <tr>
                                                                            <th scope="col">ID</th>
                                                                    ...
                                                                    <tbody id="hclaimsBody">
                                                                        <%   int count = 1;
                                                                            List<Claims> cat_list = sess.createQuery("From Claims WHERE claim_status_id ='1' AND status ='1'").list();
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="5">
                                                                                <span style="float: left;">
                                                                                    ...
                                                                                    <button type="button" class="btn btn-outline-primary" onclick="loadHclaims()" id="allButton">All</button>
                                                                                </span>
                        ...
                        <div class="row">
                            ...
                            <div class="row mb-3 mt-3">
                                <div class="col-sm-12" align="right">
                                    <button type="button" class="btn rounded-pill btn-success" style="width: 200px;" onclick="approve();" id="req_btn_approve_hac"><i class="fa fa-check"></i> Approve</button>
                                    <button type="button" class="btn rounded-pill btn-danger" style="width: 200px;" onclick="disapprove();" id="req_btn_disapprove_hac"><i class="fa fa-times"></i> Disapprove</button>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="approveClaim" tabindex="-1" aria-labelledby="approveClaim" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="row mb-3 mt-3">
                                <div class="col-sm-12" align="right">
                                    <button type="button" class="btn rounded-pill btn-outline-primary col-sm-4" onclick="approveCanceled();" id="req_btn_disapprove_hac">No</button>
                                    <button type="button" class="btn rounded-pill btn-primary col-sm-4" onclick="approveHAC(<%=login.getId()%>);" id="req_btn_approve_hac">Yes</button>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="disapproveClaim" tabindex="-1" aria-labelledby="disapproveClaim" aria-hidden="true">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header" style="padding-top: 20px !important; height: 50px;">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <%
                                UserLogin logindis = (UserLogin) request.getSession().getAttribute("user");
                            ...
                            <div class="row mb-3 mt-3">
                                <div class="col-sm-12" align="right">
                                    ...
                                    <button type="button" class="btn rounded-pill btn-primary col-sm-4"  onclick="approveCancel(<%=logindis.getId()%>);" id="req_btn_disapprove_hac">Yes</button>
                                </div>
                            </div>
                        </div>
...
//       ----- Pagination  -----
            var currentPage = 1;
            var pageSize = 10;
            var tableRows = document.querySelectorAll("#hclaimsBody tr");
